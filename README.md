...
[![version](https://img.shields.io/badge/version-3.15.0-blue)](https://github.com/googlarz/finance-assistant/releases)
[![tests](https://img.shields.io/badge/tests-1%2C400%20passing-brightgreen)](docs/ARCHITECTURE.md#testing)
...
`6 locales` · `14 bank formats + any file via LLM` · `Monte Carlo FIRE` · `1,400 tests`
