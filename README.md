...
[![tests](https://img.shields.io/badge/tests-1%2C484%20passing-brightgreen)](docs/ARCHITECTURE.md#testing)
...
`6 locales` · `14 bank formats + any file via LLM` · `Monte Carlo FIRE` · `1,484 tests`
