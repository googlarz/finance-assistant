...
[![version](https://img.shields.io/badge/version-3.16.0-blue)](https://github.com/googlarz/finance-assistant/releases)
[![tests](https://img.shields.io/badge/tests-1%2C434%20passing-brightgreen)](docs/ARCHITECTURE.md#testing)
...
`6 locales` · `14 bank formats + any file via LLM` · `Monte Carlo FIRE` · `1,434 tests`
